...
int main(){
  ...
  NodeStack<DataType> otherList(10, copyData);
  ...
  NodeStack<DataType> copiedList(otherList);
  ...
  NodeStack<DataType> assignList(10, copyData);
...
cout << "------------------------------------------------------" << endl;
   ...
   ArrayStack<DataType> emptyArray;
   ...
   const ArrayStack<DataType> assignArray = paramArray;
